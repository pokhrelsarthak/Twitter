  ...
  return (
    <div className='h-screen sticky top-0'>
      ...
      <div className='space-y-6'>
        ...
        <div className="py-10">
          <Button 
            sx={{ width: "100%", borderRadius: "30px", py: "15px", bgColor: "#199dbf" }}
            variant="contained">
            Tweet
          </Button>
        </div>
